...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/Sensors-banner.png'
...
export default function SENSORS() {
    ...
    const filteredProducts = products.filter(product => [5].includes(product.category));
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>SENSORS</h3>
