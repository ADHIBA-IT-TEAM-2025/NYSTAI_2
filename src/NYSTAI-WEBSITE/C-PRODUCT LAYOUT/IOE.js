...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/IOE-Communiation-Banner.png'
...
export default function IOECOMMUNICATION() {
    ...
    const filteredProducts = products.filter(product => [15].includes(product.category));
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>IOE - COMMUNICATION</h3>
