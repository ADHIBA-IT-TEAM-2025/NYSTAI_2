...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/Water-Leakage.png'
...
export default function WATER() {
    ...
    const filteredProducts = products.filter(product => [10].includes(product.category));
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>WATER MANAGEMENT</h3>
