...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/smart-switch-banner-3.png'
...
export default function SMARTSWITCH() {
    ...
    const filteredProducts = products.filter(product => [6].includes(product.category));
