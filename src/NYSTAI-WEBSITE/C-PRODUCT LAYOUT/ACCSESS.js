...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/Access-control-banner.png'
...
export default function Accesscontrol() {
    ...
    const filteredProducts = products.filter(product => [7].includes(product.category));
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>ACCESS CONTROL</h3>
