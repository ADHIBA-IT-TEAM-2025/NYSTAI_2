...
import laningbannerACC from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/Accessories-banner.png'
...
export default function ACCESSORIES() {
    ...
    const filteredProducts = products.filter(product => [13].includes(product.category));
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>ACCESSORIES</h3>
                                    ...
                                    <div class="product-content">
                                        ...
                                        {/* <div class="purchase-info ">
                                            <button type="button" class="btn ms-3">
                                                <Link to="/Access">Know More</Link><i class="fas fa-shopping-cart"></i></button>
                                        </div> */}
                                    </div>
                                </div>
                            </div>
