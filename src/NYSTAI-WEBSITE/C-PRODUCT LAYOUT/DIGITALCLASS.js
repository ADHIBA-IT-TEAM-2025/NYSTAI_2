...
import laningbanner from '../IMAGES-VIDEOS/B-IMG-PRODUCT-LAYOUT/Nystai-icons & resize images/Digital-Class-Banner.png'
    ...
    return (
        <>
            ...
            <div className="mt-4 mb-5">
                <h3 className='mb-4' style={{ color: "#1b6763", fontWeight: "bolder" }}>DIGITAL CLASSROOM</h3>
